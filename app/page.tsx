...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-4 overflow-hidden bg-[#050507]">
      ...
      {/* Top sacred insignia / subtle header */}
      <header className="absolute top-8 sm:top-12 left-1/2 -translate-x-1/2 z-10 flex items-center gap-3 text-zinc-500 text-xs tracking-[0.35em] uppercase font-light select-none">
        <span className="w-8 h-[1px] bg-gradient-to-r from-transparent to-zinc-700" />
        <span className="font-devanagari text-zinc-400 tracking-wider">॥ ॐ नमः शिवाय ॥</span>
        <span className="w-8 h-[1px] bg-gradient-to-l from-transparent to-zinc-700" />
      </header>
      ...
      <main className="relative z-10 flex flex-col items-center justify-center text-center max-w-4xl mx-auto py-20">
        ...
        {/* Big Center "Aarti" text */}
        <div className="relative group cursor-default">
          <h1 className="font-cinzel text-7xl sm:text-8xl md:text-9xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white via-zinc-200 to-zinc-500 select-none drop-shadow-[0_10px_35px_rgba(0,0,0,0.9)]">
            Aarti
          </h1>
